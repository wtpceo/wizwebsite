...
export const metadata: Metadata = {
  ...
  openGraph: { images: ["/theater/ep7-poster1.jpg"], title: TITLE, description: DESC, url: URL, type: "video.episode" },
}
...
const videoJsonLd = [
  {
    ...
    thumbnailUrl: "https://wiztheplanning.com/theater/ep7-poster1.jpg",
  ...
  },
  {
    ...
    thumbnailUrl: "https://wiztheplanning.com/theater/ep7-poster2.jpg",
        ...
        <section className="container mx-auto max-w-3xl px-4 py-14 md:px-6 md:py-20">
          ...
          <div className="mt-14">
            <video
              ...
              playsInline
              preload="metadata"
              poster="/theater/ep7-poster2.jpg"
              className="w-full rounded-2xl border border-white/10"
            >
