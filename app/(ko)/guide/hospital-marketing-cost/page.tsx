...
const FAQ = [
  ...
  {
    q: "병원 홈페이지 제작 비용은 왜 견적 차이가 큰가요?",
    a: "페이지 수와 언어, 그리고 검색엔진과 AI가 읽을 수 있게 만드는 작업이 들어갔는지에 따라 갈립니다. 저희가 진행한 치과는 120쪽을 4개 언어로 만들고 AI 크롤러 15종의 접근을 열어 두는 작업까지 포함했습니다. 디자인만 새로 하는 견적과 같은 금액일 수 없습니다. 견적서를 받으시면 페이지 수, 언어, 측정 설계 포함 여부를 나눠서 확인해 보세요.",
  },
  {
  ...
  return (
    <>
      ...
      >
        ...
        <h2>병원 마케팅 대행사 견적서에서 확인할 6가지</h2>
        <div className="mt-6 overflow-x-auto rounded-xl border border-slate-200">
          <table className="w-full min-w-[560px] text-sm">
            <thead>
              <tr className="bg-slate-50 text-left">
        ...
        <h3>치과·피부과처럼 진료과에 따라 달라지는 부분</h3>
        <p>
          같은 금액이라도 진료과에 따라 할 일의 양이 다릅니다. 치과 마케팅 대행사나 피부과 마케팅
          비용을 알아보실 때도 기준은 같습니다. 경쟁 병원이 많은 지역일수록 콘텐츠 양이 늘고,
          비급여 진료 비중이 높을수록 의료광고 표현을 더 조심해야 해서 검수에 시간이 들어갑니다.
          그래서 단가표보다 &ldquo;우리 진료과에서 무엇을 몇 건 하느냐&rdquo;를 물어보시는 편이
          정확합니다.
        </p>
