...
export const metadata: Metadata = {
  ...
  openGraph: {
    images: ["/covers/geo-cost.jpg"], title: TITLE, description: DESC, url: URL, type: "article",
  },
}
...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "절대 금액보다 비교 기준이 중요합니다. 기준은 '0원'이 아니라 지금 플랫폼에 내고 있는 수수료와 광고비입니다. 예를 들어 네이버 펜션 실시간예약 요율 10.45%로 연 6,700만원어치를 팔면 수수료로만 약 700만원이 나갑니다. 이미 매년 나가고 있는 돈과 비교해야 판단이 됩니다.",
      },
    },
    {
      "@type": "Question",
    ...
    <>
      ...
      >
        ...
        <p>
          ...
          약 700만원이 나갑니다(요율만 넣은 산수입니다). 이 돈은 해마다 나가는 변동비라서, 같은
          금액을 자기 채널에 쓰면 무엇이 남는지와 나란히 놓고 봐야 판단이 섭니다. 광고로 유입 경로를
          시험한 기록은{" "}
          <a href="/guide/case-pension-direct-booking">펜션 릴스 광고 24일 실측</a>에 있습니다.
        </p>
        <Callout>
