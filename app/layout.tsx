...
export const metadata: Metadata = {
  ...
  description: '위즈더플래닝은 AI 검색 최적화(GEO) 전문 풀서비스 에이전시입니다. ChatGPT·퍼플렉시티·네이버 AI가 당신의 브랜드를 추천하게 만드는 GEO부터 SEO, 메타·구글 퍼포먼스 광고 1,000건 이상, 자체 촬영·편집 제작팀, 홈페이지 제작까지 — 2016년부터 7,000여 광고주와 함께합니다.',
  keywords: [
    'AI 검색 최적화',
    'GEO',
    'GEO 전문 기업',
  ...
  '@graph': [
    {
      ...
      description:
        '위즈더플래닝은 AI 검색 최적화(GEO, Generative Engine Optimization) 전문 풀서비스 에이전시입니다. ChatGPT·퍼플렉시티·네이버 AI 같은 생성형 AI가 브랜드를 인용·추천하도록 만드는 GEO를 핵심으로, SEO·메타 광고·구글 광고 퍼포먼스 캠페인 1,000건 이상, 드라마·유명 채널 촬영감독 출신의 자체 촬영·편집 제작팀, AI가 읽는 구조의 홈페이지 제작까지 통합 제공합니다. 2016년부터 7,000여 광고주와 함께했으며, 음식점·병원·학원·뷰티 등 지역 기반 비즈니스 마케팅에 특화되어 있습니다.',
      knowsAbout: [
        'AI 검색 최적화(GEO)',
        'Generative Engine Optimization',
        '생성형 AI 검색 마케팅',
      ...
      hasOfferCatalog: {
        ...
        itemListElement: [
          ...
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: '메타 광고 운영', description: '인스타그램·페이스북 퍼포먼스 광고 캠페인 1,000건 이상 집행 경험 기반의 세팅·운영·최적화' } },
          { '@type': 'Offer', itemOffered: { '@type': 'Service', name: '구글 광고 운영', description: '구글 검색·디스플레이·PMAX 캠페인 1,000건 이상 세팅·운영 경험 기반의 퍼포먼스 관리' } },
