...
export default function sitemap(): MetadataRoute.Sitemap {
  const routes: { path: string; priority: number; changeFrequency: MetadataRoute.Sitemap[number]["changeFrequency"]; lastmod?: string }[] = [
    ...
    { path: "/en/korea-market-entry", priority: 0.9, changeFrequency: "monthly", lastmod: "2026-09-15" },
    { path: "/en/agency-partners", priority: 0.8, changeFrequency: "monthly", lastmod: "2026-09-15" },
    { path: "/en/how-we-measure", priority: 0.8, changeFrequency: "monthly", lastmod: "2026-09-15" },
    { path: "/en/business-owners-in-korea", priority: 0.8, changeFrequency: "monthly", lastmod: "2026-09-15" },
    { path: "/en/contact", priority: 0.6, changeFrequency: "monthly", lastmod: "2026-09-15" },
    { path: "/en/insights", priority: 0.7, changeFrequency: "monthly", lastmod: "2026-09-15" },
    { path: "/en/insights/marketing-in-korea-2026", priority: 0.8, changeFrequency: "monthly", lastmod: "2026-09-15" },
    { path: "/en/insights/naver-blocks-ai-crawlers", priority: 0.7, changeFrequency: "monthly", lastmod: "2026-09-15" },
    { path: "/en/insights/naver-vs-google-korea", priority: 0.7, changeFrequency: "monthly", lastmod: "2026-09-15" },
    { path: "/en/insights/case-clinic-chatgpt", priority: 0.7, changeFrequency: "monthly", lastmod: "2026-09-15" },
    { path: "/en/insights/case-dental-llms-txt", priority: 0.7, changeFrequency: "monthly", lastmod: "2026-09-15" },
    ...
    { path: "/guide/what-is-llms-txt", priority: 0.9, changeFrequency: "monthly" },
    { path: "/guide/ai-crawler-names", priority: 0.9, changeFrequency: "monthly" },
    ...
    { path: "/guide/geo-measurement-tools", priority: 0.9, changeFrequency: "monthly" },
