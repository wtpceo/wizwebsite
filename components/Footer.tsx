      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            ...
            {/* SNS 링크 */}
            <div className="flex space-x-4">
              <Link href="https://blog.naver.com/marketingrecipe-" target="_blank" rel="noopener noreferrer" className="hover:text-blue-600">
              ...
              <Link href="https://www.instagram.com/matzip_town" target="_blank" rel="noopener noreferrer" className="hover:text-pink-600">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <Link href="http://pf.kakao.com/_QUTxcb" target="_blank" rel="noopener noreferrer" className="hover:text-yellow-600">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
