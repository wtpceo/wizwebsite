...
export default function Footer() {
  return (
    <footer className="border-t border-white/10 bg-[#05080f] py-14 text-sm text-slate-400">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4">
          ...
          {/* 서비스 */}
          <nav aria-label="서비스" className="space-y-3">
            <h4 className="font-semibold text-slate-200">서비스</h4>
            <ul className="space-y-2">
              {serviceLinks.map((l) => (
                <li key={l.href}>
                  <Link href={l.href} className="transition-colors hover:text-[#00e5a0]">
                    {l.label}
                  </Link>
                </li>
              ))}
          ...
          {/* 업종별 전략 */}
          <nav aria-label="업종별 전략" className="space-y-3">
            <h4 className="font-semibold text-slate-200">업종별 전략</h4>
            <ul className="space-y-2">
              {strategyLinks.map((l) => (
                <li key={l.href}>
                  <Link href={l.href} className="transition-colors hover:text-[#00e5a0]">
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              <h4 className="font-semibold text-slate-200">고객센터</h4>
              <p>평일 10:00 - 18:00</p>
            ...
            <div className="flex space-x-4 pt-2">
              <Link href="https://blog.naver.com/marketingrecipe-" target="_blank" rel="noopener noreferrer" aria-label="네이버 블로그" className="hover:text-[#00e5a0]">
              ...
              <Link href="https://www.instagram.com/matzip_town" target="_blank" rel="noopener noreferrer" aria-label="인스타그램 맛집타운" className="hover:text-[#00e5a0]">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <Link href="http://pf.kakao.com/_QUTxcb" target="_blank" rel="noopener noreferrer" aria-label="카카오톡 채널" className="hover:text-[#00e5a0]">
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
