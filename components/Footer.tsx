...
export default function Footer() {
  return (
    <footer className="border-t border-white/10 py-12 bg-[#05080f] text-slate-400 text-sm">
          ...
          <div className="space-y-4">
            <div className="flex flex-col space-y-2">
              <Link 
                ...
                className="text-[#00e5a0] hover:underline inline-flex items-center"
              >
                사업자정보확인
            ...
            {/* SNS 링크 */}
            <div className="flex space-x-4">
              <Link href="https://blog.naver.com/marketingrecipe-" target="_blank" rel="noopener noreferrer" className="hover:text-[#00e5a0]">
              ...
              <Link href="https://www.instagram.com/matzip_town" target="_blank" rel="noopener noreferrer" className="hover:text-[#00e5a0]">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <Link href="http://pf.kakao.com/_QUTxcb" target="_blank" rel="noopener noreferrer" className="hover:text-[#00e5a0]">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
