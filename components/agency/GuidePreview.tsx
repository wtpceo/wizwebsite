        ...
        <div className="mx-auto mt-12 grid max-w-5xl gap-5 md:grid-cols-3">
          {GUIDES.map((guide, i) => (
            ...
            >
              <Link
                href={guide.href}
                className="group flex h-full flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white transition-all hover:-translate-y-1 hover:border-emerald-500/40 hover:shadow-xl hover:shadow-emerald-500/[0.07]"
              >
                <div className="aspect-[16/9] overflow-hidden bg-slate-100">
                  <img
                    src={coverFor(guide.href)}
                    alt=""
                    width={1200}
                    height={675}
                    loading="lazy"
                ...
                <div className="flex flex-1 flex-col p-6 md:p-7">
                  <p className="text-[11px] font-bold tracking-[0.2em] text-emerald-600">
                    {guide.kicker}
                  </p>
